...
const PostWrite = (props) => {
	...
	console.log(props.match.params.id); //아이디 출력하기
	...
	return (
		<React.Fragment>
			...
			<Grid>
				...
				<Image shape="rectangle" src={preview? preview : "https://cdn-blackknightm.pressidium.com/wp-content/uploads/2018/04/Web-design.png"} />
			</Grid>
